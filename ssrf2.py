...
class SSRF:
    ...
    def process_parameters(self, flow):
        ...
        for watched_param in self.watched_parameters:
            for param in params:
                if watched_param in param:  # Check if watched_param is a substring of param
                    value = params[param][0] if isinstance(params[param], list) else params[param]
                    self.alter_and_replay_ssrf(flow, param, value)
